                            ...
                            if (this.payment.providerId == "1") {
                                ...
                                this.postForm("post-to-fastpay", this.payment.paymentLink, 
                                    { 
                                        ...
                                        "SUCCESS_URL": "https://payment.dev-pk.symplified.ai/payment-redirect?name=" + this.order.orderShipmentDetail.receiverName + "&email="+ this.order.orderShipmentDetail.email + "&phone=" + this.order.orderShipmentDetail.phoneNumber + "&amount="+this.paymentDetails.cartGrandTotal.toFixed(2)+"&hash=&status_id=1&order_id="+this.order.id+"&transaction_id="+transactionId+"&msg=Payment_was_successful&payment_channel=fastpay", 
                                        "FAILURE_URL": "https://payment.dev-pk.symplified.ai/payment-redirect?name=" + this.order.orderShipmentDetail.receiverName + "&email="+ this.order.orderShipmentDetail.email + "&phone=" + this.order.orderShipmentDetail.phoneNumber + "&amount="+this.paymentDetails.cartGrandTotal.toFixed(2)+"&hash=&status_id=0&order_id="+this.order.id+"&transaction_id="+transactionId+"&msg=Payment_was_failed&payment_channel=fastpay", 
