                            ...
                            if (this.payment.providerId == "1") {
                                ...
                                this.postForm("post-to-fastpay", this.payment.paymentLink, 
                                    { 
                                        ...
                                        "SUCCESS_URL": this._apiServer.settings.apiServer.paymentService + "/payments/payment-redirect", 
                                        "FAILURE_URL": this._apiServer.settings.apiServer.paymentService + "/payments/payment-redirect", 
